...
def groups(request):
    ...
    return render(request, 'dozoo_app/groups.html', params)
...
def creategroup(request):
    ...
    return redirect(to='/dozoo_app/groups')
...
def post(request, message_id):
    ...
    return render(request, 'dozoo_app/post.html', params)
...
def share(request, share_id):
    ...
    return render(request, 'dozoo_app/share.html', params)
